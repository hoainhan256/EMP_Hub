"""
Django settings for EMPSites project.
...
SECRET_KEY = 'django-insecure-4#=9!25q1vgm*vmfbr)=pv(a32_=om_@k(_7op4ct+od%584dt'
...
WSGI_APPLICATION = 'EMPSites.wsgi.application'
